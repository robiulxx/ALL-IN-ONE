        ...
        if user_id in user_temp_data:
            ...
            if temp_client:
                try:
                    ...
                    asyncio.run(temp_client.stop() if isinstance(temp_client, PyroClient) else temp_client.disconnect())
                except:
                    pass
...
def register(bot, custom_command_handler, COMMAND_PREFIXES):
    ...
    def handle_text(message):
        ...
        if not step:
            return  # Not part of sessiongen flow
